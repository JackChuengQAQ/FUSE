...
public:
    ...
    std::string getTopK() {
        return options_value[OptionKeyword::TopK] == "" ? "0" : options_value[OptionKeyword::TopK];
    }

    std::string getBatchQueryDir() {
        return options_value[OptionKeyword::BatchQueryDir];
    }

    
    std::string getVertexLabelMatch() {
        return options_value[OptionKeyword::VertexLabelMatch] == "" ? "none"
                                                                   : options_value[OptionKeyword::VertexLabelMatch];
    }
};
