...
class GeneralEvaluation
{
	...
	public:
		GeneralEvaluation(KVstore *_kvstore, Statistics *_statistics, StringIndex *_stringindex, QueryCache *_query_cache, \
			...
			TYPE_ENTITY_LITERAL_ID _limitID_entity, CSR *_csr,HopIndex *hop_index, shared_ptr<Transaction> txn = nullptr);
		...
		bool doQuery(TopKStrategy top_k_method=TopKStrategy::DP_B);
	...
	public:
		...
		TempResultSet* queryEvaluation(int dep,TopKStrategy top_k_method=TopKStrategy::DP_B);
